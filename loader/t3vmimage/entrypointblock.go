...
func LoadEntryPointBlock(data []byte, size int, flags int) {
	...
	debugTableLocalSymbolRecordHeaderSize := loader.ReadU2_Buffer(data, 12)
	...
	debugRecordsVersionNumber := loader.ReadU2_Buffer(data, 14)
